...
public final class IngestionResponse {
    ...
    public record Detail(UUID id, String source, String status, UUID projectId, String accountReference,
                         ...
                         String lastErrorCode, UUID receiptId, Instant processedAt, String origin) {
    }

    public record RetryAccepted(UUID ingestionEventId, String status, boolean duplicate) { }
}
